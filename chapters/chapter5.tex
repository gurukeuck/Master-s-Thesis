...
\begin{enumerate}
    \item \mintinline{Python}{GetConfig} is called by the recipe generator client which could be a machine operator, a PLC or a production planner. \begin{tabbing}
